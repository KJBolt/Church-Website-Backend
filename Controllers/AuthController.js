...
const generateAccessToken = (user) => {
    return jwt.sign({id:user._id, isAdmin:user.isAdmin}, process.env.JWT, {expiresIn:'72h'})
}
...
export const register = async(req, res) => {
    ...
    try {
        ...
        // Generate Token
        const token = jwt.sign({id:user._id, isAdmin:user.isAdmin, email:req.body.email}, process.env.JWT);
